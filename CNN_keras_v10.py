...
train_path = r'/home/newuser/Desktop/FINAL/final cnn code/train/'
valid_path = r'/home/newuser/Desktop/FINAL/final cnn code/validation/'
test_path = r'/home/newuser/Desktop/FINAL/final cnn code/test/'



train_batch = ImageDataGenerator(rescale=1/.255).flow_from_directory(train_path, target_size=(128,141),classes=['NOENH','SERS'], batch_size = 32)
valid_batch = ImageDataGenerator(rescale=1/.255).flow_from_directory(valid_path, target_size=(128,141),classes=['NOENH','SERS'], batch_size = 32)
...
classifier.save('SERS_NOSERS_pillars.h5')
...
classifier = load_model(r'/home/newuser/Desktop/FINAL/final cnn code/SERS_NOSERS_pillars.h5')
...
plt.legend()
plt.savefig(r'/home/newuser/Desktop/FINAL/final cnn code/generated images/Training and validation accuracy.png', dpi = 300,bbox_inches="tight")
#plt.show()
...
plt.legend()
plt.savefig(r'/home/newuser/Desktop/FINAL/final cnn code/generated images/Training and validation loss.png', dpi = 300,bbox_inches="tight")
#plt.show()

from keras.layers import InputLayer

model = Sequential()
# model.add(InputLayer(input_shape=(128,141)))
for layer in classifier.layers:
    model.add(layer)
...
#    fig ,(ax1,ax2) = plt.subplots(1,2)
    ...
    if num > 0:
        ...
        fig.savefig(r'/home/newuser/Desktop/FINAL/final cnn code/generated images/'+file[i]+'.png', dpi = 300,bbox_inches="tight")
