...
#        smoothed_signal = Normalize(smoothed_signal,zscore,inv)
        ...
        plt.savefig(r'C:\Users\paulo\OneDrive - University of Birmingham\Desktop\birmingham_02\MEng student\3rd year\DATA\raman fit test\raman spec7'+'\\'+(f"{i+1:04d}")+'.png',bbox_inches='tight')
        plt.close()
...
files = r'C:\Users\paulo\OneDrive - University of Birmingham\Desktop\birmingham_02\MEng student\3rd year\DATA\Raman\sample1\sample1_part7_pillar_a_to_wn_10uM_MB_633nm_50x_10%_1s_3acc_1450cm-1_map1.txt'
