...
while cap.isOpened():
    ...
    #        ret, frame = test.read()
            ...
            test_image,division= break_image1(frame,size)
...
#            
#            croppedimage =  buildup2(frame,final_heat)
#            plt.figure()
#            plt.imshow(croppedimage)
#            plt.savefig(r'C:\Users\paulo\OneDrive - University of Birmingham\Desktop\birmingham_02\MEng student\3rd year\report\code\files to transfer\final images\\'+'final_image'+str(count)+'.png', dpi = 300,bbox_inches="tight")
#            plt.close()
        except:
            pass
    else:
