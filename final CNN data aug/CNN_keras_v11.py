...
train_path =  r'/home/newuser/Desktop/emily try/Data2(part1+part3+part4+part6)/Training/'
valid_path = r'/home/newuser/Desktop/emily try/Data2(part1+part3+part4+part6)/Validation'
test_path = r'/home/newuser/Desktop/emily try/Data2(part1+part3+part4+part6)/Testing/'
...
train_batch = ImageDataGenerator(rescale=1/.255).flow_from_directory(train_path, target_size=(150,150),classes=['nonSERS','SERS'], batch_size = 32)
valid_batch = ImageDataGenerator(rescale=1/.255).flow_from_directory(valid_path, target_size=(150,150),classes=['nonSERS','SERS'], batch_size = 32)
...
classifier.save(r'/home/newuser/Desktop/emily try/Data2(part1+part3+part4+part6)/SERS_NOSERS_pillars_v02.h5')
...
# classifier = load_model(r'/home/newuser/Desktop/emily try/Data2(part1+part3+part4+part6)/SERS_NOSERS_pillars_v02.h5')
...
# plt.legend()
# plt.savefig(r'/home/newuser/Desktop/emily try/Data2(part1+part3+part4+part6)/gen/Training and validation accuracy.png', dpi = 300,bbox_inches="tight")
# #plt.show()
...
# plt.legend()
# plt.savefig(r'/home/newuser/Desktop/emily try/Data2(part1+part3+part4+part6)/gen/Training and validation loss.png', dpi = 300,bbox_inches="tight")
# #plt.show()
...
#             fig.savefig(r'/home/newuser/Desktop/emily try/Data2(part1+part3+part4+part6)/gen/'+file[i]+'.png', dpi = 300,bbox_inches="tight")
