...
test_path = r'/home/newuser/Desktop/emily try/Data8_4600points100k/Testing/'
...
classifier.save(r'/home/newuser/Desktop/emily try/Data8_4600points100k/SERS_NOSERS_pillars_v09.h5')
...
classifier = load_model(r'/home/newuser/Desktop/emily try/Data8_4600points100k/SERS_NOSERS_pillars_v09.h5')
...
plt.legend()
plt.savefig(r'/home/newuser/Desktop/emily try/Data8_4600points100k/gen2/Training and validation accuracy.png', dpi = 300,bbox_inches="tight")
#plt.show()
...
plt.legend()
plt.savefig(r'/home/newuser/Desktop/emily try/Data8_4600points100k/gen2/Training and validation loss.png', dpi = 300,bbox_inches="tight")
#plt.show()
...
#    fig ,(ax1,ax2) = plt.subplots(1,2)
    ...
    if num > 0:
        ...
        fig.savefig(r'/home/newuser/Desktop/emily try/Data8_4600points100k/gen2/'+file[i]+'.png', dpi = 300,bbox_inches="tight")
