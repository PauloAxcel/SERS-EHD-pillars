...
train_path =  r'/home/newuser/Desktop/emily try/Data5_3890points/Training/'
valid_path = r'/home/newuser/Desktop/emily try/Data5_3890points/Validation/'
test_path = r'/home/newuser/Desktop/emily try/Data5_3890points/Testing/'
...
classifier.save(r'/home/newuser/Desktop/emily try/Data5_3890points/SERS_NOSERS_pillars_v06.h5')
...
classifier = load_model(r'/home/newuser/Desktop/emily try/Data5_3890points/SERS_NOSERS_pillars_v06.h5')
...
plt.legend()
plt.savefig(r'/home/newuser/Desktop/emily try/Data5_3890points/gen/Training and validation accuracy.png', dpi = 300,bbox_inches="tight")
#plt.show()
...
plt.legend()
plt.savefig(r'/home/newuser/Desktop/emily try/Data5_3890points/gen/Training and validation loss.png', dpi = 300,bbox_inches="tight")
#plt.show()
...
for i in range(len(file)):
    ...
    #    fig ,(ax1,ax2) = plt.subplots(1,2)
        ...
        if num > 0:
            ...
            fig.savefig(r'/home/newuser/Desktop/emily try/Data5_3890points/gen/'+file[i]+'.png', dpi = 300,bbox_inches="tight")
